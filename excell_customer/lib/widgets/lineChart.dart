...
class _UtilLineChartState extends State<UtilLineChart> {
  ...
  List<Color> gradientColors = [Color(0xffb993d6), Color(0xff8ca6db)];
  ...
  LineChartData mainData(_results) {
    ...
    if (maxX == 3.0)
      ...
      stepValues = [2, 5, 8, 12, 14];
    else if (maxX == 16.0)
      stepValues = [2, 5, 8, 11, 15];
    else if (maxX == 17.0)
      stepValues = [2, 6, 9, 12, 16];
    else if (maxX == 18.0)
      stepValues = [2, 7, 10, 13, 17];
    else if (maxX == 19.0)
      stepValues = [2, 7, 12, 14, 18];
    else if (maxX == 20.0)
      stepValues = [2, 8, 13, 16, 19];
    else if (maxX == 21.0)
      stepValues = [2, 6, 11, 16, 20];
    else if (maxX == 22.0)
      stepValues = [2, 6, 12, 17, 21];
    else if (maxX == 23.0)
      stepValues = [2, 7, 12, 18, 22];
    else if (maxX == 24.0)
      stepValues = [2, 8, 13, 19, 23];
    else if (maxX == 25.0)
      stepValues = [2, 8, 14, 20, 24];
    else if (maxX == 26.0)
      stepValues = [2, 8, 15, 21, 25];
    else if (maxX == 27.0)
      stepValues = [2, 8, 15, 22, 26];
    else if (maxX == 28.0)
      stepValues = [2, 8, 16, 22, 27];
    else if (maxX == 29.0)
      stepValues = [2, 9, 18, 24, 28];
    else if (maxX == 30.0)
      stepValues = [2, 10, 18, 24, 29];
    else if (maxX == 31.0) stepValues = [2, 12, 18, 24, 30];
      ...
      lineBarsData: [
        LineChartBarData(
          ...
          belowBarData: BarAreaData(show: true, colors: [
            ColorTween(begin: gradientColors[0], end: gradientColors[1]).lerp(0.2).withOpacity(0.5),
