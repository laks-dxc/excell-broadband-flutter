  ...
  final Map<FooterState, dynamic> modelFooterProps = {
    ...
    FooterState.ValidatedCredentialsResultWrong: {
      "child": Text(
        ...
        style: TextStyle(
            color: Colors.red, fontSize: 20, fontWeight: FontWeight.w100),
      ),
      "color": selectedTheme.disabledBackground,
    },
            ...
            case FooterState.ValidCredentialsEntered:
              {
                ...
                Customer.authenticate(
                        customerIdController.text, mobileNoController.text)
      ...
      child: TextFormField(
        ...
        onChanged: (_customerId) {
          ...
          if (_customerId.trim().isNotEmpty &&
              mobileNoController.text.trim().length == 10)
                  ...
                  Padding(
                    ...
                    child: PinCodeTextField(
                      ...
                      pinTheme: PinTheme(
                          ...
                          borderWidth: 1.5,
                          selectedColor:
                              selectedTheme.activeBackground.withOpacity(0.3),
                      ...
                      onCompleted: (_enteredOTP) {
                        if (_enteredOTP.toString() == receivedOTP ||
                          ...
                          Customer.saveFBToken(customerIdController.text,
                              mobileNoController.text);

                          Customer.details(customerIdController.text,
                                  mobileNoController.text)
                              ...
                              onFinished: () {
                                if (showResendText) {
                                  ...
                                  setState(() {
                                    ...
                                    footerColor =
                                        modelFooterProps[FooterState.ResendOTP]
                                            ["color"];
                                    footerText =
                                        modelFooterProps[FooterState.ResendOTP]
                                            ["child"];
