...
class _TimelineState extends State<Timeline> {
  ...
  void initState() {
    ...
    Customer.getConnectionLogs(connectionDetail["pkgnum"].toString())
        .then((value) {
      // print('conn logs ' + value.toString());
      setState(() {
        connectionLogs = value;
        if (connectionLogs!.last["data_pack_type"] != "PostFUP")
          connectionLogs!.add({
            "data_pack_type": "Consumed",
            "usedData": Utils.bytesToSize(connectionDetail["data"].toString())
          });
              ...
              child: Stack(
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      Text(Utils.formatDateTimeString(connectionLogs![index]
                              ["data_pack_date"]
                      ...
                      Padding(
                        ...
                        child: RichText(
                          text: TextSpan(
                            ...
                            children: <TextSpan>[
                              TextSpan(text: "Using "),
                              connectionLogs![index]["data_pack_limit"] ==
                                      'Unltd'
                                  ? TextSpan(text: "a unlimited package ")
                                  : TextSpan(text: ""),
                              TextSpan(
                                  text: connectionDetail["pkgname"],
                                  style:
                                      TextStyle(fontWeight: FontWeight.bold)),
                              TextSpan(text: " with "),
                              TextSpan(
                                  text: connectionDetail["pkgdetail"],
                                  style:
                                      TextStyle(fontWeight: FontWeight.bold)),
                              TextSpan(text: " plan."),
                            ],
                      ...
                      children: [
                        Align(
                            ...
                            child: Padding(
                              ...
                              child: Text(
                                connectionLogs![index]["data_pack_type"]
                                    .toString(),
                                style: TextStyle(
                                    fontSize: 40,
                                    color: selectedTheme.primaryColor
                        ...
                        Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(Utils.formatDateTimeString(
                                connectionLogs![index]["data_pack_date"]
                                    .toString())), //.split(" ")[0].toString()),
                              ...
                              child: RichText(
                                text: TextSpan(
                                  ...
                                  children: <TextSpan>[
                                    ...
                                    TextSpan(
                                        text:
                                            " bonus data added. The new limit is "),
                                    TextSpan(
                                        text: connectionLogs![index]
                                                    ["data_new_limit"]
                                                .toString() +
                        ...
                        child: RichText(
                          text: TextSpan(
                            ...
                            children: <TextSpan>[
                              ...
                              TextSpan(
                                  text:
                                      " of Post FUP data consumed. Total data consumptiion is "),
                              index == connectionLogs!.length - 1
                                  ? TextSpan(text: "about ")
                                  : TextSpan(text: ""),
                              TextSpan(
                                  text: connectionLogs![index]["data_new_limit"]
                                          .toString() +
                                      " GB"),
                              index == connectionLogs!.length - 1
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        connectionLogs![index]["data_pack_notes"]
                                .toString()
                                .replaceAll("[", "")
                                .replaceAll("]", "") +
                            ".",
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        "You have consumed about " +
                            connectionLogs![index]["usedData"] +
                            " data till now.",
                        style: TextStyle(color: selectedTheme.primaryText),
                      )
                    ],
