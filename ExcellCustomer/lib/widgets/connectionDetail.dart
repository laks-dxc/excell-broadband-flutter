...
class ConnectionDetail extends StatefulWidget {
  ...
  @override
  _ConnectionDetailState createState() =>
      _ConnectionDetailState(connectionDetailItem);
}
...
*/
              ...
              Padding(
                ...
                child: Container(
                  decoration: BoxDecoration(
                      color: selectedTheme.inActiveBackground.withOpacity(0.2),
                    ...
                    child: Column(
                      children: <Widget>[
                        tileItem(
                            "Package",
                            Utils.clipStringTo(
                                connectionDetailItem["pkgname"], 20),
                            inactive: true),
                        tileItem("Plan", connectionDetailItem["pkgdetail"],
                            inactive: true),
                        tileItem("IP Address", connectionDetailItem["ip_addr"],
                            inactive: true),
                        tileItem("Status", connectionDetailItem["status"],
                            inactive: true),
                      ],
                    ),
                  ),
                      ...
                      children: <Widget>[
                        tileItem(
                            ...
                            Utils.formatDateString(
                                connectionDetailItem["suspend_date"]),
                            inactive: true),
                        tileText(
                            "Reason:  " +
                                connectionDetailItem["suspend_reason"]
                                    .toString(),
                            inactive: true)
                      ],
                    ),
              ...
              connectionDetailItem["datalimit"] != null
                  ? Padding(
                      ...
                      child: Container(
                        decoration: BoxDecoration(
                            color:
                                selectedTheme.activeBackground.withOpacity(0.2),
                            borderRadius:
                          ...
                          child: Column(
                            children: <Widget>[
                              tileItem(
                                  "Plan Data",
                                  Utils.bytesToSize(
                                      connectionDetailItem["datalimit"])),
                              connectionDetailItem["paybonus"] != null
                                  ? tileItem(
                                      "Pay Bonus",
                                      Utils.bytesToSize(
                                          connectionDetailItem["paybonus"]))
                                  : SizedBox(
                                      width: 0,
                                    ),
                              connectionDetailItem["topup_total_gb"] != "0"
                                  ? tileItem(
                                      "Total Top Ups",
                                      double.parse(connectionDetailItem[
                                                      "topup_total_gb"]
                                                  .toString())
                                              .toStringAsFixed(2) +
                                          " GB")
                        ...
                        children: [
                          ElevatedButton(
                            style: ElevatedButton.styleFrom(
                              ...
                              backgroundColor:
                                  selectedTheme.primaryGradientColors![1],
                            ...
                            onPressed: () {
                              if (connectionDetailItem["topup_eligibility"] ==
                                  1) {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (BuildContext context) => Scaffold(
                                      backgroundColor:
                                          selectedTheme.scaffoldBgColor,
                                      appBar: AppBar(
                                          title: Text("Select Topup"),
                                          backgroundColor: selectedTheme
                                              .appBarColor //(0xff112c75),
                                          ),
                                      body: TopupsList(
                                          connectionDetailItem["pkgnum"]
                                              .toString()),
                                    ),
                                  ),
                                );
                              } else if (connectionDetailItem[
                                      "topup_eligibility"] ==
                                  0) {
                                    ...
                                    builder: (BuildContext context) =>
                                        new Dialog(
                                          child: Padding(
                                            ...
                                            child: Text(connectionDetailItem[
                                                    "topupeligibility_note"]
                                                .toString()
                                                .replaceAll("|", "\n")),
                                          ),
                                        ));
                            ...
                            onPressed: () {
                              setState(() {
                                ...
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (BuildContext context) =>
                                        Utilization(connectionDetailItem),
                                  ),
                                );
                              });
                            },
  ...
  Widget utilizationTile() {
    ...
    consumedData = connectionDetailItem["data"] == null
        ? 0
        : int.parse(connectionDetailItem["data"]);
    ...
    if (isUnlimited)
      consumedString =
          "Total " + Utils.bytesToSize(consumedData.toString()) + " consumed ";
    else {
      totalDataLimit = connectionDetailItem["grand_total"];

      if (consumedData == 0)
        consumedString = "0.00 GB of " +
            Utils.bytesToSize(totalDataLimit.toString()) +
            " consumed ";
      else {
        consumedString = "Total " +
            Utils.bytesToSize(consumedData.toString()) +
            " of " +
            Utils.bytesToSize(totalDataLimit.toString()) +
            " used ";
      }
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
                color: selectedTheme.primaryColor
                    .withOpacity(0.3), //Colors.green[100],
                borderRadius: BorderRadius.all(Radius.circular(15.0))),
          ),
        ),
        Container(
            ...
            children: [
              ...
              connectionDetailItem["postfup_total"].toString() != "0"
                  ? Text(
                      "* Includes " +
                          Utils.bytesToSize(
                              connectionDetailItem["postfup_total"]
                                  .toString()) +
                          " of post FUP utilization",
                      style: TextStyle(
  ...
  Widget tileItem(label, value, {inactive = false}) {
    return Padding(
      ...
      child: Container(
          ...
          decoration: BoxDecoration(
              color: inactive
                  ? selectedTheme.inActiveBackground.withOpacity(0.5)
                  : selectedTheme.activeBackground.withOpacity(0.5),
