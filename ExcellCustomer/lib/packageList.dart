            ...
            child: citiesLoaded
                ? TypeAheadFormField(
                    ...
                    onSuggestionSelected: (String suggestion) {
                      ...
                      Customer.getBBPlans(location["location_id"])
                          .then((value) {
                        setState(() {
                          planDetails = value;
                        });
    ...
    return Padding(
      ...
      child: Column(
        children: <Widget>[
          ...
          planItem(
              "Amount",
              Utils.showAsMoney(planDetails[index]["plan_amount"],
                  precision: 0)),
        ],
      ),
    );
    ...
    return Row(
      ...
      children: <Widget>[
        ...
        Text(
          value,
          style: TextStyle(
              fontWeight: FontWeight.w600, fontSize: 16 * textScaleFactor!),
        )
      ],
    );
  }
