...
class _MyPackagesState extends State<MyPackages> {
  ...
  showData() {
    return connections!.length > 1
        ...
        : connections!.length == 0
            ? noConnectionsPage()
            : ConnectionDetail(connections?[0]);
  }
            ...
            child: Stack(children: [
              ...
              Align(
                  ...
                  child: Icon(Icons.cancel,
                      size: 90, color: Colors.red.withOpacity(0.5))),
            ]),
            padding: EdgeInsets.all(16.0),
            decoration: BoxDecoration(
                color: selectedTheme.inActiveBackground,
                          ...
                          MaterialPageRoute(
                            builder: (BuildContext context) => Scaffold(
                              ...
                              appBar: AppBar(
                                  ...
                                  backgroundColor:
                                      selectedTheme.appBarColor //(0xff112c75),
                                  ),
  ...
  connectionListItemContainer(connectionListItem) {
    print('connectionListItem["status"]  ' +
        connectionListItem["status"].toString());
    return Container(
      width: displaySize?.width,
      padding: EdgeInsets.all(8.0 * textScaleFactor!),
      child: Container(
          decoration: BoxDecoration(
              color: connectionListItem["status"].toString() == 'Active'
                  ? selectedTheme.activeBackground
                  : selectedTheme.inActiveBackground,
              ...
              child: Column(
                ...
                children: <Widget>[
                  Row(
                    ...
                    children: <Widget>[
                      Text(
                          Utils.clipStringTo(connectionListItem["pkgname"], 18),
                      ...
                      Text(connectionListItem["pkgdetail"],
                          style: TextStyle(
                              color:
                                  selectedTheme.primaryColor.withOpacity(0.8),
                              fontSize: 20 * textScaleFactor!)),
                      Text(connectionListItem["status"],
                          style: TextStyle(
                              color:
                                  selectedTheme.primaryColor.withOpacity(0.8),
                              fontSize: 20 * textScaleFactor!)),
