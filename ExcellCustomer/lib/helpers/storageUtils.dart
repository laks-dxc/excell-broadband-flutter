...
class StorageUtils {
  ...
  static Future<Map<StorageKey, String>> getStorageItems(
      List<StorageKey> keys) async {
    Map<StorageKey, String> storageItems = {};

    Future futureStorageValuss =
        Future.wait(List.generate(keys.length, (index) {
  ...
  static setStrorageList(StorageKey key, List<String> list) async {
    final SharedPreferences prefs = await _prefs;
